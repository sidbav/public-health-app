...
// household-food survey
    if(type == 'household-food'){
        ...
        const survey = await SurveyTypeOne.create({surveyResult,score,surveyDate, dateOrder,type,HH2, HH3,HH4,AD1,AD1a,AD2,AD3,AD4,AD5,AD5a,CH1,CH2,CH3,CH4,CH5,CH5a,CH6,CH7} );
        await survey.save()
