...
- For exmaple, inside the `server.js`, I load the port number from env.
    ...
    Storing configuration![Untitled Notebook (18)-1](https://user-images.githubusercontent.com/34131663/193482249-5aae643d-ff3d-425e-a7ac-e571a9ccbbe0.jpg =250x250)
